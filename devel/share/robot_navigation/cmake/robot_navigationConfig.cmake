...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/robot/charlie_ws/src/robot_navigation_v1)
  set(robot_navigation_DEVEL_PREFIX /home/robot/charlie_ws/devel)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/robot/charlie_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'waiyang <pyo@robotis.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/charlie_ws/src/robot_navigation_v1/${idir}'.  ${_report}")
    endif()
