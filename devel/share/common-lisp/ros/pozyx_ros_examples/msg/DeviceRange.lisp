...
(cl:in-package pozyx_ros_examples-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <DeviceRange>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeviceRange)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pozyx_ros_examples-msg:<DeviceRange> is deprecated: use pozyx_ros_examples-msg:DeviceRange instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <DeviceRange>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:timestamp-val is deprecated.  Use pozyx_ros_examples-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <DeviceRange>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:distance-val is deprecated.  Use pozyx_ros_examples-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'RSS-val :lambda-list '(m))
(cl:defmethod RSS-val ((m <DeviceRange>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:RSS-val is deprecated.  Use pozyx_ros_examples-msg:RSS instead.")
  (RSS m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DeviceRange>)))
  ...
  "pozyx_ros_examples/DeviceRange")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DeviceRange)))
  "Returns string type for a message object of type 'DeviceRange"
  "pozyx_ros_examples/DeviceRange")
