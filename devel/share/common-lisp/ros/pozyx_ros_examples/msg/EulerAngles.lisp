...
(cl:defmethod cl:initialize-instance :after ((m <EulerAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EulerAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pozyx_ros_examples-msg:<EulerAngles> is deprecated: use pozyx_ros_examples-msg:EulerAngles instead.")))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:yaw-val is deprecated.  Use pozyx_ros_examples-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:roll-val is deprecated.  Use pozyx_ros_examples-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx_ros_examples-msg:pitch-val is deprecated.  Use pozyx_ros_examples-msg:pitch instead.")
  (pitch m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EulerAngles>)))
  ...
  "pozyx_ros_examples/EulerAngles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EulerAngles)))
  "Returns string type for a message object of type 'EulerAngles"
  "pozyx_ros_examples/EulerAngles")
